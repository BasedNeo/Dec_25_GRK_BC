...
export function Navbar({ activeTab, onTabChange, isConnected }: NavbarProps) {
  ...
  const navItems = [
    ...
    { id: 'saga-guide', label: t('nav.sagaGuide', 'Saga Guide') },
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-black/60 backdrop-blur-xl border-b border-white/5 shadow-[0_4px_30px_rgba(0,0,0,0.5)] fixed-header">
