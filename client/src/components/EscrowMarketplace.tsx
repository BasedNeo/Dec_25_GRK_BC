...
import { NFTCardSkeletonGrid } from "@/components/ui/NFTCardSkeleton";
                ...
                {isLoading || directLoading ? (
                    <div className="space-y-6">
                        <div className="flex items-center gap-3 p-4 rounded-lg bg-cyan-500/10 border border-cyan-500/30">
                            ...
                            <span className="text-cyan-400 font-orbitron text-sm">SYNCING WITH BASEDAI BLOCKCHAIN...</span>
                        </div>
                        <NFTCardSkeletonGrid count={12} />
                    </div>
